...
const countries = [
  // ── Already have (Muslim-majority / high traffic) ──
...
const countryGroups = [
  {
    ...
    countries: countries.filter(c => [
      ...
      "iraq","jordan","lebanon","syria","yemen","palestine","iran",
    ].includes(c.slug)),
  },
  {
    region: "South Asia",
  ...
  },
  {
    ...
    countries: countries.filter(c => [
      ...
      "hong-kong","kazakhstan","uzbekistan","tajikistan","kyrgyzstan",
  ...
  },
  {
    ...
    icon: "🏜️",
    countries: countries.filter(c => [
      "egypt","morocco","algeria","tunisia","libya","sudan","south-sudan","mauritania"
    ].includes(c.slug)),
  },
  {
    region: "West Africa",
    icon: "🌍",
    countries: countries.filter(c => [
      "nigeria","ghana","senegal","mali","niger","guinea","ivory-coast",
      "burkina-faso","benin","togo","sierra-leone","liberia","gambia",
      "guinea-bissau","cape-verde","mauritius"
    ].includes(c.slug)),
  },
  {
    region: "East Africa",
    icon: "🦁",
    countries: countries.filter(c => [
      "kenya","tanzania","ethiopia","uganda","somalia","rwanda","burundi",
      "mozambique","madagascar","djibouti","eritrea","comoros","seychelles"
    ].includes(c.slug)),
  },
  {
    ...
    icon: "🌿",
    countries: countries.filter(c => [
      "south-africa","angola","zambia","zimbabwe","namibia","botswana",
      "congo","democratic-republic-of-congo","cameroon","gabon","chad",
  ...
  },
  {
    ...
    countries: countries.filter(c => [
      ...
      "belgium","sweden","norway","denmark","finland","poland","russia",
      "ukraine","turkey","austria","switzerland","portugal","greece",
      "czech-republic","hungary","romania","bulgaria","serbia","croatia",
      "bosnia-and-herzegovina","albania","kosovo","north-macedonia",
      "montenegro","slovenia","slovakia","latvia","lithuania","luxembourg",
      "malta","moldova","cyprus","ireland","georgia","armenia","azerbaijan"
    ].includes(c.slug)),
  },
  {
    ...
    countries: countries.filter(c => [
      ...
      "jamaica","haiti","trinidad-and-tobago","costa-rica","panama",
